                        ...
                        <tr>
                            ...
                            <form action="buyProduct" method="POST">
                                ...
                                <select  id="qty" name="qty"  >
                                    <?php
                                    if (!empty($customerDetails[0]['max_payment'])){
                                        $limit_from_price = (int)($customerDetails[0]['max_payment']/$product['price']);
                                        $limit = min((int)$product['stock'],(int)$customerDetails[0]['order_constraint'],$limit_from_price);
                                    }else{
                                        $limit = min((int)$product['stock'],(int)$customerDetails[0]['order_constraint']);
                                    }
                                ...
                                <td>
                                    <select type="text" id="route" name="route" style="margin:0px;" >
                                        <?php
                                ...
                                <td><input name="shipping_address" style=" padding-top: 10px;  width: 100%;margin-right: 10px;"required> </td>
