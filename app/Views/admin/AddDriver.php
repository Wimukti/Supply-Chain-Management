...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
            ...
            <div class="sidebar-brand-text mx-3">Supply Chain Management</sup></div>
        </a>
        ...
        <li class="nav-item active">
            <a class="nav-link" href="viewHome">
        ...
        <!-- Nav Item - Tables -->
        <li class="nav-item">
            <a class="nav-link" href="addDriver">
                <i class="fas fa-fw fa-table"></i>
                <span>Add Driver/Driver</span></a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="addTruck">
                <i class="fas fa-fw fa-table"></i>
                <span>Add Truck</span></a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="addTrainSchedule">
                <i class="fas fa-fw fa-table"></i>
                <span>Add Train Schedule</span></a>
        </li>
        <li class="nav-item">
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    <h1 class="h3 mb-0 text-gray-800">Add Driver/ Driver Assistant</h1>
                </div>
                <form class="user" action="registerDriver" method="POST">
                    ...
                    <div class="form-group">
                        <select class="form-control form-select form-select-user" aria-label=".form-select-lg example" name="position">
                    ...
                    <div class="form-group">
                        <input type="number" class="form-control form-control-user" id="exampleInputEmail"
                               name="tel_no" placeholder="Telephone Number">
                    </div>
                    <div class="form-group">
                        <input type="text" class="form-control form-control-user" id="exampleInputEmail"
                    ...
                    <div class="form-group">
                        <select class="form-control form-select form-select-user" aria-label=".form-select-lg example" name="city_id" >
                            <?php
